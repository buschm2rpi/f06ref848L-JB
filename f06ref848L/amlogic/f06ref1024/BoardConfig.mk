...
TARGET_BOOTLOADER_BOARD_NAME := f06ref1024
...
TARGET_AMLOGIC_AML_LOGO := device/amlogic/common/res/logo/ainol.boot.1024x600.bmp
TARGET_AMLOGIC_LOGO := device/amlogic/common/res/logo/ainol.kernel.1024x600.bmp
