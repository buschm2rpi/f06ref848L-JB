...
PRODUCT_NAME := f06ref1024
PRODUCT_MANUFACTURER := Ainol
PRODUCT_DEVICE := f06ref1024
PRODUCT_MODEL := NOVO7 Mars
...
PRODUCT_COPY_FILES += \
	device/amlogic/f06ref1024/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
# Wifi driver
PRODUCT_COPY_FILES += device/amlogic/f06ref1024/8192cu.ko:system/lib/8192cu.ko
PRODUCT_COPY_FILES += device/amlogic/f06ref1024/mali.ko:root/boot/mali.ko
PRODUCT_COPY_FILES += device/amlogic/f06ref1024/ump.ko:root/boot/ump.ko
...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/../common/res/logo/ainol.1024x600.rle:root/initlogo.rle.bak \
...
DEVICE_PACKAGE_OVERLAYS := device/amlogic/f06ref1024/overlay
