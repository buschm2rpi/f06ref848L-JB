...
TARGET_BOOTLOADER_BOARD_NAME := f08ref
...
TARGET_AMLOGIC_AML_LOGO := device/amlogic/common/res/logo/robot.800x480.rle
TARGET_AMLOGIC_LOGO := device/amlogic/common/res/logo/robot.800x480.bmp
