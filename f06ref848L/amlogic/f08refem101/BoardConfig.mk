...
BOARD_USES_G_SENSOR_MEMSIC_MMM8452_MMC328X := false
...
TARGET_BOOTLOADER_BOARD_NAME := f08refem101
...
TARGET_AMLOGIC_AML_LOGO := device/amlogic/common/res/logo/robot.1024x768.rle
TARGET_AMLOGIC_LOGO := device/amlogic/common/res/logo/robot.1024x768.bmp
