...
/// patch for clk81
    private static final String CLK81_FRQ_LEVEL = "/sys/class/aml_clk81/clk81_freq_level";
    void setClk81FrqLevel(String level) {
        writeSysfs(CLK81_FRQ_LEVEL, level);
    }
/// patch for clk81
    ...
    private void videobar() {
		...
		if(AmPlayer.getProductType() == 1){
			if (SettingsVP.display_mode.equals("480p") && SettingsVP.panel_height > 480) {
				...
				FrameLayout.LayoutParams frameParams = (FrameLayout.LayoutParams) baselayout2.getLayoutParams();
				if (SettingsVP.panel_width > 1024)
				    frameParams.width = 1024;
