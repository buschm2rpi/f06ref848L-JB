...
PRODUCT_MANUFACTURER := Henag
PRODUCT_DEVICE := mid7306ce
PRODUCT_MODEL := HENAG 7306ce
...
PRODUCT_COPY_FILES += \
	device/amlogic/mid7306ce/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
# ssd253x Touch Screen
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/ssd253x-ts.idc:system/usr/idc/ssd253x-ts.idc \
...
# Wifi driver
PRODUCT_COPY_FILES += device/amlogic/mid7306ce/dhd.ko:system/lib/dhd.ko
PRODUCT_COPY_FILES += device/amlogic/mid7306ce/mali.ko:root/boot/mali.ko
PRODUCT_COPY_FILES += device/amlogic/mid7306ce/ump.ko:root/boot/ump.ko
...
#bcm40181 wifi
PRODUCT_COPY_FILES += \
	hardware/amlogic/wifi/bcm_4018x/config/40181/fw_bcm40181a0.bin:system/etc/wifi/40181/fw_bcm40181a0.bin \
	hardware/amlogic/wifi/bcm_4018x/config/40181/fw_bcm40181a0_apsta.bin:system/etc/wifi/40181/fw_bcm40181a0_apsta.bin \
	hardware/amlogic/wifi/bcm_4018x/config/40181/fw_bcm40181a2.bin:system/etc/wifi/40181/fw_bcm40181a2.bin \
	hardware/amlogic/wifi/bcm_4018x/config/40181/fw_bcm40181a2_apsta.bin:system/etc/wifi/40181/fw_bcm40181a2_apsta.bin \
	hardware/amlogic/wifi/bcm_4018x/config/40181/fw_bcm40181a2_p2p.bin:system/etc/wifi/40181/fw_bcm40181a2_p2p.bin \
	hardware/amlogic/wifi/bcm_4018x/config/40181/nvram.txt:system/etc/wifi/40181/nvram.txt 
#	hardware/amlogic/wifi/bcm_4018x/config/40183/fw_bcm40183b2.bin:system/etc/wifi/40183/fw_bcm40183b2.bin \
#	hardware/amlogic/wifi/bcm_4018x/config/40183/fw_bcm40183b2_apsta.bin:system/etc/wifi/40183/fw_bcm40183b2_apsta.bin \
#	hardware/amlogic/wifi/bcm_4018x/config/40183/fw_bcm40183b2_p2p.bin:system/etc/wifi/40183/fw_bcm40183b2_p2p.bin \
#	hardware/amlogic/wifi/bcm_4018x/config/40183/nvram.txt:system/etc/wifi/40183/nvram.txt 
...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/../common/res/logo/hena.800x480.rle:root/initlogo.rle.bak \
...
DEVICE_PACKAGE_OVERLAYS := device/amlogic/mid7306ce/overlay
