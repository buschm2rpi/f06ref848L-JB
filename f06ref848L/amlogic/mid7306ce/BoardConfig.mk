...
# misc
IGNOR_COMMON_AMLOGIC_PICKIT := true
...
BOARD_USES_SENSOR_BMA222 :=	false
BOARD_USES_G_SENSOR_MMA8452 :=	false
...
# Wifi
WIFI_DRIVER := bcm4018x
WIFI_DRIVER_WHO := bcm40181
...
TARGET_BOOTLOADER_BOARD_NAME := mid7306ce
...
TARGET_AMLOGIC_AML_LOGO := device/amlogic/common/res/logo/hena.boot.800x480.bmp
TARGET_AMLOGIC_LOGO := device/amlogic/common/res/logo/hena.kernel.800x480.bmp
