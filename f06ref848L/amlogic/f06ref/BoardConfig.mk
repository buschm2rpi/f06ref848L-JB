...
#BOARD_USES_SENSOR_BMA222 :=true

BOARD_USES_G_SENSOR_MMA8452 :=true
...
WIFI_DRIVER_FW_PATH_STA := /etc/wifi/sdio-g-cdc-full11n-reclaim-roml-wme-idsup.bin
WIFI_DRIVER_FW_PATH_AP := /etc/wifi/sdio-g-cdc-roml-reclaim-wme-apsta-idsup-idauth.bin

TARGET_BOOTLOADER_BOARD_NAME := f06ref
...
TARGET_AMLOGIC_AML_LOGO := device/amlogic/common/res/logo/ainol.boot.1280x768.bmp
TARGET_AMLOGIC_LOGO := device/amlogic/common/res/logo/ainol.kernel.1280x768.bmp
