...
TARGET_BOOTLOADER_BOARD_NAME := f06ref848L
...
TARGET_AMLOGIC_AML_LOGO := device/amlogic/common/res/logo/ainol.boot.800x480.bmp
TARGET_AMLOGIC_LOGO := device/amlogic/common/res/logo/ainol.kernel.800x480.bmp
