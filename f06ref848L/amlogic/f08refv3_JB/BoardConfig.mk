...
TARGET_BOOTLOADER_BOARD_NAME := f08refv3_JB
...
TARGET_AMLOGIC_AML_LOGO := device/amlogic/common/res/logo/em79.1024x600.rle
TARGET_AMLOGIC_LOGO := device/amlogic/common/res/logo/em79.1024x600.bmp
